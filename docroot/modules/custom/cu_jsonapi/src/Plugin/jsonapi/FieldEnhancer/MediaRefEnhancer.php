...
namespace Drupal\cu_jsonapi\Plugin\jsonapi\FieldEnhancer;
 ...
 *   id = "cu_media_ref",
 *   label = @Translation("Enhance media reference"),
 *   description = @Translation("Adds metadata about the referenced media/file entity.")
 * )
 */
class MediaRefEnhancer extends ResourceFieldEnhancerBase implements ContainerFactoryPluginInterface {
  ...
  protected function doUndoTransform($data, Context $context) {
    \Drupal::logger('cu_jsonapi')->notice(__LINE__ . ' ' . print_r($data, TRUE));
    \Drupal::logger('cu_jsonapi')->notice(__LINE__ . ' ' . print_r($context, TRUE));
    /*
    if (isset($data['uri'])) {
