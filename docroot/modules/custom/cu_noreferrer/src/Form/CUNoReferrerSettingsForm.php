...
namespace Drupal\cu_noreferrer\Form;
...
class CUNoReferrerSettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'cu_noreferrer_settings_form';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->config('cu_noreferrer.settings')
  ...
  public function publish() {
    if ($whitelist = $this->config('cu_noreferrer.settings')->get('whitelisted_domains')) {
