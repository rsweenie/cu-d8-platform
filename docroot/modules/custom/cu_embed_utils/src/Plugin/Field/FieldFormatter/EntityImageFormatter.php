...
namespace Drupal\cu_embed_utils\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'entity_image_formatter' formatter.
 *
 * @FieldFormatter(
 *   id = "entity_image_formatter",
 *   label = @Translation("Entity image formatter"),
 *   field_types = {
 *     "image"
 *   }
 * )
 */
class EntityImageFormatter extends ImageFormatterBase implements ContainerFactoryPluginInterface {
...
/**
 * Constructs a new EntityImageFormatter object.
 *
